...
var loadDots = function loadDots() {
  if (dots) {
...
var createGraph = function createGraph(data) {
  ...
  var svg = d3.select("#app").append("div").style("font", "inherit").style("font-size", "10px").style("text-align", "right").style("color", "white").style("margin-top", "3%").style("overflow", "scroll");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bookshelf.js"], null)
//# sourceMappingURL=/bookshelf.a0c66224.js.map