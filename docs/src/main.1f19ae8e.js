...
var PopUpBox = /*#__PURE__*/function (_HTMLElement) {
  ...
  function PopUpBox() {
    ...
    header.appendChild(close); // CONTENT

    var type = _this.getAttribute('popup-type');
    ...
    console.log(_this.getAttribute('data-text'));
    info.textContent = text;
    shadow.appendChild(wrapper);
    wrapper.appendChild(header); // Insert icon

    if (_this.hasAttribute('data-image')) {
      var imgUrl;
      imgUrl = _this.getAttribute('data-image');

      var caption = _this.getAttribute('data-caption');
    ...
    content.appendChild(info); // Apply external styles to the shadow DOM

    var linkElem = document.createElement("link");
    linkElem.setAttribute("rel", "stylesheet");
    linkElem.setAttribute("href", "style.css"); // Attach the created element to the shadow DOM
